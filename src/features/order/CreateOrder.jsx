...
function CreateOrder() {
  ...
  return (
    <div>
      ...
      {/* By default, React Router will match the closet route */}
      <Form method="POST">
        <div>
        ...
        <div>
          ...
          <div>
            <input
              ...
              name="address"
              required
              className="py2 w-full rounded-full border border-stone-200 px-4 py-2 transition-all duration-300 placeholder:text-stone-400 focus:outline-none focus:ring focus:ring-yellow-400 md:px-6 md:py-3"
            />
          </div>
        </div>
